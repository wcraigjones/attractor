...
FACTORY_AUTH_BASIC_PASSWORD_HASH="${FACTORY_AUTH_BASIC_PASSWORD_HASH:-}"
FACTORY_AUTH_BASIC_REALM="${FACTORY_AUTH_BASIC_REALM:-Attractor Factory}"
FACTORY_AUTH_BASIC_EXISTING_SECRET_NAME="${FACTORY_AUTH_BASIC_EXISTING_SECRET_NAME:-}"
...
auth:
  basic:
    username: "${FACTORY_AUTH_BASIC_USERNAME}"
    passwordHash: "${FACTORY_AUTH_BASIC_PASSWORD_HASH}"
    realm: "${FACTORY_AUTH_BASIC_REALM}"
    existingSecretName: "${FACTORY_AUTH_BASIC_EXISTING_SECRET_NAME}"
EOF
